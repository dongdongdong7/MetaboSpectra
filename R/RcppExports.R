...
.calculate_spectral_entropy <- function(peaks) {
    .Call(`_MetaboSpectra_r_calculate_spectral_entropy`, peaks)
}
...
.clean_spectrum <- function(peaks, min_mz, max_mz, noise_threshold, min_ms2_difference_in_da, min_ms2_difference_in_ppm, max_peak_num, normalize_intensity) {
    .Call(`_MetaboSpectra_r_clean_spectrum`, peaks, min_mz, max_mz, noise_threshold, min_ms2_difference_in_da, min_ms2_difference_in_ppm, max_peak_num, normalize_intensity)
}
...
.calculate_unweighted_entropy_similarity <- function(peaks_a, peaks_b, ms2_tolerance_in_da, ms2_tolerance_in_ppm, clean_spectra, min_mz, max_mz, noise_threshold, max_peak_num) {
    .Call(`_MetaboSpectra_r_calculate_unweighted_entropy_similarity`, peaks_a, peaks_b, ms2_tolerance_in_da, ms2_tolerance_in_ppm, clean_spectra, min_mz, max_mz, noise_threshold, max_peak_num)
}
